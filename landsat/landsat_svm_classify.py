...
"""
introduction: Using SVM in sklearn library to perform classification on landsat trend
...
if __name__ == "__main__":
    usage = "usage: %prog [options] trend_file1 trend_file2 ..."
    parser = OptionParser(usage=usage, version="1.0 2019-6-25")
    parser.description = 'Introduction: Using SVM in sklearn library to perform classification on landsat trend'
    ...
    basic.setlogfile('landsat_svm_log.txt')
