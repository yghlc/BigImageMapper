...
dem=${PWD}/qtp_srtm_v3_30m_crop.tif

slope=${outdir}/qtp_srtm_v3_30m_crop_sagaSlope
aspect=${outdir}/qtp_srtm_v3_30m_crop_sagaAspect

# import raster (convert to tif to grid format)
dem_grid=${outdir}/qtp_srtm_v3_30m_crop.sdat
if [ ! -f $dem_grid ]; then
    #
