...
###############################################################################
# changes 23March2018
# Mosaic classification results of remote sensing images
# One pixel could be assigned to several classes in different images
# So output the classes with highest probability
