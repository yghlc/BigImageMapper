...
testid=$(basename $PWD)
inf_dir=inf_results_160
para_file=para.ini
para_py=~/codes/PycharmProjects/DeeplabforRS/parameters.py

#rm -r ${inf_dir}

#python ${eo_dir}/deeplab_inference.py --frozen_graph=frozen_inference_graph_iter30000.pb --inf_output_dir=${inf_dir}


# merge patches
### post processing
output=map_result_160.tif
