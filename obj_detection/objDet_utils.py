...
def plot_yolo_bboxes(tif_path, txt_path, class_names=None, box_color='red'):
    """
    Plot TIFF image with YOLO bounding boxes.
...
def checking_yolo_boxes():
    ...
    # file_name = 's2_2024_RGB_id0095800934_1326_48'
    # file_name = 's2_2024_RGB_id0111100748_1412_35'
    file_name = 's2_2024_RGB_id0064700509_1084-from_2_grids_22'

    img_path = os.path.join(data_dir,f'{file_name}.tif')
    txt_path = os.path.join(data_dir,f'{file_name}.txt')


    plot_yolo_bboxes(img_path,txt_path,class_names=class_names)
...
def get_bounding_boxes_from_vector_file(img_path_list, vector_path):
    ...
    for idx, img_path in enumerate(img_path_list):
        ...
        if not os.path.isfile(save_crop_vector):
            ...
            #TODO: keep or not keep these polygons touches the edge, if not keep, rise warning
