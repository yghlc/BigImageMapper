...
#introduction: Run the whole process of mapping landforms using mmseg(mmsegmentation)
#
...
${eo_dir}/mmseg_dir/mmseg_train.py ${para_file} ${gpu_num}
...
${eo_dir}/mmseg_dir/mmseg_predict.py ${para_file}
