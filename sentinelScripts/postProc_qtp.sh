...
for (( n=0; n<${num}; n++ ));
    ...
    cp_shapefile ${inf_dir}/I${n}_${testid}_prj_post result_backup/I${n}_${testid}_prj_post_${test}
    cp_shapefile ${inf_dir}/I${n}_${testid}_prj result_backup/I${n}_${testid}_prj_${test}
